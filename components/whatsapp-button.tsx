...
export function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute right-16 bg-card text-foreground px-3 py-2 rounded-lg shadow-md text-sm font-medium whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
        Chat with us
      </span>
    </button>
  );
